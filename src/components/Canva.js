...
const Canva = (props) => {
  ...
  const [datasetVisibility, setDatasetVisibility] = useState(Array(2).fill(true));
        ...
        {datasets.map((dataset, datasetIndex) => (
          <div key={datasetIndex} className={clss.legendItem}>
            <div
              ...
              style={{ backgroundColor: dataset.data[0].color, opacity: datasetVisibility[datasetIndex] ? 1 : 0.3 }}
